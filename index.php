...
<body>
    ...
    <section class="trombi">
    <?php
        foreach($StudentData as $Student) {
    ?>
        <figure class="apprenant">
            <img src="images/photos/MAD_<?php echo $Student[3];?>.jpg" alt="<?php echo $Student[0];?>">
            <figcaption>
            <?php echo ucfirst(strtolower($Student[1]));?> <?php echo strtoupper($Student[2]);?><br>(<?php echo $Student[4];?> ans)<br><br>
            <?php echo $Student[5];?>
            </figcaption>
        </figure>
    <?php } ?>
